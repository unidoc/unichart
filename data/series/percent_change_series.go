...
var (
	...
	_ data.FirstValuesProvider    = (*PercentChangeSeries)(nil)
	_ data.LastValuesProvider     = (*PercentChangeSeries)(nil)
	_ data.ValueFormatterProvider = (*PercentChangeSeries)(nil)
)
...
type PercentChangeSeriesSource interface {
	...
	data.FirstValuesProvider
	data.LastValuesProvider
	data.ValuesProvider
	data.ValueFormatterProvider
}
...
func (pcs PercentChangeSeries) GetValueFormatters() (x, y data.ValueFormatter) {
	x, _ = pcs.InnerSeries.GetValueFormatters()
	y = data.PercentValueFormatter
	return
}
...
func (pcs PercentChangeSeries) Render(r render.Renderer, canvasBox render.Box, xrange, yrange data.Range, defaults render.Style) {
