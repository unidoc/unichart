...
var (
	...
	_ data.FirstValuesProvider = (*EMASeries)(nil)
	_ data.LastValuesProvider  = (*EMASeries)(nil)
)
...
func (ema *EMASeries) Render(r render.Renderer, canvasBox render.Box, xrange, yrange data.Range, defaults render.Style) {
