...
var (
	...
	_ data.FirstValuesProvider    = (*TimeSeries)(nil)
	_ data.LastValuesProvider     = (*TimeSeries)(nil)
	_ data.ValueFormatterProvider = (*TimeSeries)(nil)
)
...
func (ts TimeSeries) GetValueFormatters() (x, y data.ValueFormatter) {
	x = data.TimeValueFormatter
...
func (ts TimeSeries) Render(r render.Renderer, canvasBox render.Box, xrange, yrange data.Range, defaults render.Style) {
