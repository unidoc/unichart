...
var (
	...
	_ data.FirstValuesProvider = (*SMASeries)(nil)
	_ data.LastValuesProvider  = (*SMASeries)(nil)
)
...
func (sma SMASeries) GetStyle() render.Style {
	return sma.Style
}
...
func (sma SMASeries) getAverage(index int) float64 {
	...
	floor := mathutil.MaxInt(0, index-period)
	var accum float64
	var count float64
...
func (sma SMASeries) Render(r render.Renderer, canvasBox render.Box, xrange, yrange data.Range, defaults render.Style) {
