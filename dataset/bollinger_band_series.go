...
func (bbs *BollingerBandsSeries) Render(r render.Renderer, canvasBox render.Box, xrange, yrange sequence.Range, defaults render.Style) {
...
func drawBoundedSeries(r render.Renderer, canvasBox render.Box, xrange, yrange sequence.Range, style render.Style, bbs BoundedValuesProvider, drawOffsetIndexes ...int) {
	drawOffsetIndex := 0
