...
func (ls *LinearSeries) Render(r render.Renderer, canvasBox render.Box, xrange, yrange sequence.Range, defaults render.Style) {
...
func drawLineSeries(r render.Renderer, canvasBox render.Box, xrange, yrange sequence.Range, style render.Style, vs ValuesProvider) {
	if vs.Len() == 0 {
		return
	}
