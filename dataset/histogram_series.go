...
func (hs HistogramSeries) Render(r render.Renderer, canvasBox render.Box, xrange, yrange sequence.Range, defaults render.Style) {
...
func drawHistogramSeries(r render.Renderer, canvasBox render.Box, xrange, yrange sequence.Range, style render.Style, vs ValuesProvider, barWidths ...int) {
	if vs.Len() == 0 {
		return
	}
