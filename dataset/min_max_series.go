...
func (ms *MinSeries) Render(r render.Renderer, canvasBox render.Box, xrange, yrange sequence.Range, defaults render.Style) {
...
// Render renders the series.
func (ms *MaxSeries) Render(r render.Renderer, canvasBox render.Box, xrange, yrange sequence.Range, defaults render.Style) {
	style := ms.Style.InheritFrom(defaults)
	drawLineSeries(r, canvasBox, xrange, yrange, style, ms)
}
